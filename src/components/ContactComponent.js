...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email){
        ...
        if (this.state.touched.firstname && this.state.firstname.length < 3) errors.firstname='First Name should be more than 3';
        else if (this.state.touched.firstname && this.state.firstname.length > 10) errors.firstname='First Name should be less than 10';
        if (this.state.touched.lastname && this.state.lastname.length < 3) errors.lastname='Last Name should be more than 3';
        else if (this.state.touched.lastname && this.state.lastname.length > 10) errors.lastname='Last Name should be less than 10';
