...
class Contact extends Component {
    ...
    handleSubmit(values){
        this.props.postFeedback(values.firstname,values.lastname,values.telnum,values.email,values.agree,values.controlType,values.message);
                    ...
                    <div className='col-12 col-md-9'>
                        <Form onSubmit={(values) => this.handleSubmit(values)} model='feedback'>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".email" type='email' id='email' name='email' placeholder='Email' 
                                    className='form-control'
                                    validators={{required,
                                        validEmail
                                        }}
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={{size:3, offset:1}}>
                                    <Control.select model='.controlType' name='contactType' className='control-select'>
                                    <option>Tel.</option>
                                    <option>Email</option>
                                    </Control.select>
                                </Col>
